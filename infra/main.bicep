...
param nimbusBridgeApiExists bool
@secure()
param nimbusBridgeApiDefinition object
...
resource rg 'Microsoft.Resources/resourceGroups@2022-09-01' = {
  name: 'rg-nimbusbridge-${environmentName}'
  location: location
  tags: tags
}
...
module nimbusBridgeApi './app/NimbusBridgeApi.bicep' = {
  name: 'NimbusBridgeApi'
  params: {
    name: '${abbrs.appContainerApps}nimbusbridge-${resourceToken}'
    location: location
    tags: tags
    identityName: '${abbrs.managedIdentityUserAssignedIdentities}nimbusbridge-${resourceToken}'
    applicationInsightsName: monitoring.outputs.applicationInsightsName
    containerAppsEnvironmentName: appsEnv.outputs.name
    containerRegistryName: registry.outputs.name
    exists: nimbusBridgeApiExists
    appDefinition: nimbusBridgeApiDefinition
  }
  scope: rg
}

module eventHubs './shared/eventhubs.bicep' = {
  name: 'eventhubs'
  params: {
    location: location
    tags: tags
